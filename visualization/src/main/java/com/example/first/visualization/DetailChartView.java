    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < XLabel.length; i++) {
            try {
                ...
                //canvas.drawText(String.valueOf(i+1), xPoint + i * xScale + halfXLabel/2, yPoint + displacement * 3, textPaint); // 显示更详细信息时，横坐标并不从1开始，而是从start到end
                ...
                if (i == 0) {
                    ...
                    */
                    ...
                    canvas.drawLine(xPoint + (i - 1) * xScale + halfXLabel, YCoord(Data[i - 1]), xPoint
                            + i * xScale + halfXLabel, YCoord(Data[i]), dataPaint);
                    canvas.drawCircle(xPoint + i * xScale + halfXLabel, YCoord(Data[i]),
                            circleSize, dataPaint);                  // Data[i]   or   Data[i-1]
                }
            } catch (Exception e) {
            }
        }
        ...
        if (!selectData.equals("")) {
            ...
            canvas.drawText(selectData, selectX + displacement, YCoord(selectData) - displacement, selectCirclePaint);
...
/*
            ...
            Log.i("tag_confirm",String.valueOf(START_END_COUNT));
*/
        }
    }
...
/*
                        ...
                        //AlertDialog.Builder alert = new AlertDialog.Builder(com.example.first.visualization.Main.this);
*/
                    }
                }
