...
*/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("time", xPoint + xLength, YPoint + displacement * 3, textPaint); // 月份/time
        canvas.drawText("value", xPoint + displacement, YPoint - YLength, textPaint); // 金额/value
