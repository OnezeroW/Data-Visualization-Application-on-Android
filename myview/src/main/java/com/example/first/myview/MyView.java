package com.example.first.myview;
...
public class MyView extends View{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画Y轴
        canvas.drawLine(XPoint, YPoint - YLength, XPoint, YPoint, paint); // (60,20);(60,260)

        //Y轴箭头
        canvas.drawLine(XPoint, YPoint - YLength, XPoint - 3, YPoint-YLength + 6, paint);  //箭头  (60,20);(57,26)
        canvas.drawLine(XPoint, YPoint - YLength, XPoint + 3, YPoint-YLength + 6 ,paint);        //(60,20);(63,26)
